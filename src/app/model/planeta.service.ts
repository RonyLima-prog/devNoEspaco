...
import { chanceDeVidaPlanetaService } from './chance-vida-planeta.service';
...
export class PlanetaService {
  ...
  constructor(
    ...
    private chanceDeTerVidaService: chanceDeVidaPlanetaService
  ) {}
  ...
  getPlanetas(): Planeta[] {
    this.planetas = this.planetas.map((planeta) => {
      ...
      planeta.chanceDeTerVida =
        this.chanceDeTerVidaService.aChanceDeTerVidaEh(planeta);
      return planeta;
    });
